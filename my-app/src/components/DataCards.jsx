...
export function DataCards() {
  ...
  const handleIncrement = () => setDisplayCount((prev) => prev + 1);
  ...
  return (
    <div className="view-card layout-panel-cards">
      <h2> 2-Column Cards Counter: {displayCount}</h2>

      <div className="cards-grid">
        {isFetchPending ? (
          <p style={{ gridColumn: '1 / -1', textAlign: 'center', opacity: 0.6 }}>Loading...</p>
        ) : (
